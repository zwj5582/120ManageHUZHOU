...
window.onload=function ()
{
	...
	oMsgbox=document.getElementById('content_div');
	...
	oMsgbox.style.left=(document.body.scrollLeft||document.documentElement.scrollLeft)+((document.documentElement.clientWidth-oMsgbox.offsetWidth)-1100)+'px';
	oMsgbox.style.top=(document.body.scrollTop||document.documentElement.scrollTop)+((document.documentElement.clientHeight-oMsgbox.offsetHeight)-480)+'px';
