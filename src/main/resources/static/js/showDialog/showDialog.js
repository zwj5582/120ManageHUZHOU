...
function showExtDialog(mode, msg, t, sd_width) {
...
function showWindow(title, the_url, sd_width) {
	...
	$.ajax({
		...
		success		: function(data){
			showExtDialog("window", data, title, sd_width);
		},
		error		: function(data){
			showExtDialog("alert", "读取数据失败");
		},
		beforeSend	: function(data){
			showExtDialog("loading", "正在读取数据...");
		}
	});
}

function showConfirm(msg, fn) {
	showExtDialog("confirm", msg);
	$("#SD_confirm").unbind("click");
	$("#SD_confirm").bind("click", function(){
		if(fn) {
			fn();
...
function showConfirm(msg, t,width,fn) {
	showExtDialog("confirm", msg,t,width);
	$("#SD_confirm").unbind("click");
	$("#SD_confirm").bind("click", function(){
		if(fn) {
			fn();
